public class Client extends User {
    ...
    public String getFuture_Session() { return Future_Session; }
    public void setFuture_Session(String Future_Session) { this.Future_Session = Future_Session; }

    public String getPast_Session() { return Past_Session; }
    public void setPast_Session(String Past_Session) { this.Past_Session = Past_Session; }
